          ...
          {/* <Grid size={{ xs: 12 ,sm: 6 ,md: 2.4 }}>
            <Stack spacing={4}>
              <Box>
                ...
                <Link href="" sx={{ color: 'rgba(255,255,255,0.6)', fontSize: '13px', textDecoration: 'none', '&:hover': { color: 'white' } }}>mindcraftstudio</Link>
              </Box>
              <Box>
          ...
          <Grid size={{ xs: 12 ,sm: 4 ,md: 6 }}>
            <Stack spacing={4}>
              <Box>
                ...
                <Typography sx={{ color: 'rgba(255,255,255,0.6)', fontSize: '12px', lineHeight: 1.5 }}>
                  Room no 5, jansewa ambewadi, RK Singh Marg, Mogra Village, Mogra Pada, Natwar Nagar, Andheri East, <br />
                  Mumbai, Maharashtra 400069
                </Typography>
              </Box>
              <Box>
                <Typography variant="caption" sx={{ color: 'rgba(255,255,255,0.6)', fontWeight: 700, display: 'block', mb: 1 }}>COOPERATION</Typography>
                <Link href="mailto:" sx={{ color: 'rgba(255,255,255,0.6)', fontSize: '13px', textDecoration: 'none', '&:hover': { color: 'white' } }}>partners@mindcraftstudio.net</Link>
              </Box>
            </Stack>
          </Grid>
