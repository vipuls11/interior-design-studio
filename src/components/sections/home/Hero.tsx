...
const Hero = () => {
  ...
  const posterUrl = 'https://media.studia-54.com/mainpage_poster_desktop_d32d52173b.webp';
  ...
  return (
    ...
    >
      ...
      {showVideo && (
        ...
        >
          <source src="https://s3.ru1.storage.beget.cloud/4b5ae5ff7535-studia-videos/glavnaya_obrezano_1cad87c532.mp4" type="video/mp4" />
        </Box>
      )}
